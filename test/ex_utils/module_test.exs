defmodule ExUtils.Tests.Module do
  ...
  test "#name returns Module name without Elixir namespace" do
    assert ExUtils.Module.name(SomeModule)     == "SomeModule"
    assert ExUtils.Module.name(Another.Module) == "Another.Module"
  end
end
